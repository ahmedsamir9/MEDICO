    ...
    public void onBindViewHolder(@NonNull final RoomViewHolder holder, final int position) {
        ...
        holder.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                f.getFragmentManager().beginTransaction().replace(R.id.frame_container,new ChatFragment(roomlist.get(position).getName(),roomlist.get(position).getPhoto(),name)).commit();
